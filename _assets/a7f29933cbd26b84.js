(self["webpackChunk_canva_web"] = self["webpackChunk_canva_web"] || []).push([
  [86064],
  {
    /***/ 775822: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        var bcc;
        __c.q1 = function (a, b, c) {
          return new __c.sb(a, c ? __c.ub(c) : void 0, __c.Jaa, {
            ignoreTag: !0,
          }).format(Object.fromEntries(Object.entries(b)));
        };
        __c.acc = function (a, b) {
          __c.u(!0);
          __c.u(!0);
          __c.u(!0);
          const { la: c, a: d, b: e } = __c.ys(a),
            { la: f, a: g, b: h } = __c.ys(b);
          a = (c + f) / 2;
        ...
        __c.ccc = {
          ...
          Ye(a) {
            return __c.Ao({
              ...
              action: a.action,
              location: a.location,
              linked_design_id: a.rXb,
              toggle_value: a.jI,
              editing_context: a.Vc == null ? void 0 : __c.Bo(a.Vc),
              performance_context: a.zd == null ? void 0 : __c.Co(a.zd),
            });
          },
        };
        __c.r1 = bcc;
